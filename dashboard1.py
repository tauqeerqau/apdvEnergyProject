...
plotly_map = px.choropleth(
    ...
    hover_data={
        "country_name": True,
        "electricity_use_kwh_per_capita": ":.0f"
    },
...
st.altair_chart(
    ...
    .encode(
        ...
        tooltip=["country_name", "electricity_use_kwh_per_capita"]
    ),
...
# ============================================================
st.subheader("🌱 Renewable Electricity Share")
...
if not filtered_df.empty:
    area_chart = alt.Chart(filtered_df.sort_values("year")).mark_area(
        ...
        tooltip=["country_name", "year", "renewable_electricity_percent"]
    )
